...
if (isset($_POST["save"])) {
    ...
    if( in_array($imageFileType,$extensions_arr) ){
        ...
        // Insert record
        $query = "INSERT INTO ebay_card (phone, email, amount_100, quantity_100, price_100, amount_50, quantity_50, price_50, amount_25, quantity_25, price_25, status,  bank, account_name, account_number, currency, image, t_ref)
...
'$amount_25', '$quantity_25', '$price_25', '$status', '$bank', '$account_name', '$account_number', '$currency', '".$image."', '$ref')";
        ...
        header('Refresh:3; url=ebay-trades');
        $_SESSION['success']  = "Ebay Trade Successful!! Trade Reference ID: $ref";

    }

    if ($db->query === TRUE) {
        echo "<script>alert('Ebay Trade Successful. We Will Contact You. Trade Reference ID: $ref')</script>";
...
?>
            ...
            <main>
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Sell Ebay Gift Card</li>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="ebay-card" enctype='multipart/form-data' >
                                                ...
                                                <table border="0">
                                                    <tr>
                                                        ...
                                                        <td><input type="hidden" value="<?php
                                                            ...
                                                            // connect to database
                                                            $db = mysqli_connect('localhost', 'letxchan_admin', 'letxchan_Passme@123', 'letxchan_mycard');
    ...
    border-radius: 5px;">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <label>Upload Ebay Card</label><i class="text-danger">*</i>
                                        ...
                                        <!-- submit button -->
                                        <div class="form-group ">
                                            <br><br><input type="submit" name="save" class="btn btn-sm btn-color btn-primary" value="Trade Ebay">
                                        </div>
