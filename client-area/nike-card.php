...
if (isset($_POST["save"])) {
    ...
    if( in_array($imageFileType,$extensions_arr) ){
        ...
        // Insert record
        $query = "INSERT INTO nike_card (phone, email, amount_100, quantity_100, price_100, amount_50, quantity_50, price_50, amount_25, quantity_25, price_25, status,  bank, account_name, account_number, currency, image, t_ref)
...
'$amount_25', '$quantity_25', '$price_25', '$status', '$bank', '$account_name', '$account_number', '$currency', '".$image."', '$ref')";
        ...
        header('Refresh:3; url=nike-trades');
        $_SESSION['success']  = "Nike Trade Successful!! Trade ID: $ref";
    }

    if ($db->query === TRUE) {

        echo "<script>alert('Nike Trade Successful. Trade ID: $ref')</script>";
...
?>
            ...
            <main>
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Sell Nike Gift Card</li>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="nike-card" enctype='multipart/form-data' >
    ...
    border-radius: 5px;">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <label>Upload Nike Card</label><i class="text-danger">*</i>
                                        ...
                                        <div class="form-group ">
                                            <br><br><input type="submit" name="save" class="btn btn-sm btn-color btn-primary" value="Trade Nike">
                                        </div>
