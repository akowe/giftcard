...
if (isset($_POST["save"])) {
    ...
    $email = $_POST["email"];
    $phone = $_POST["phone"];
    $amount_100     =   e($_POST['g_amount_100']);
    $quantity_100   =   e($_POST['g_quantity_100']);
    $price_100      =   e($_POST['g_price_100']);

    $amount_50      =   e($_POST['g_amount_50']);
    $quantity_50    =   e($_POST['g_quantity_50']);
    $price_50       =   e($_POST['g_price_50']);

    $amount_25      =   e($_POST['g_amount_25']);
    $quantity_25    =   e($_POST['g_quantity_25']);
    $price_25       =   e($_POST['g_price_25']);
    ...
    if( in_array($imageFileType,$extensions_arr) ){
        ...
        // Insert record
        $query = "INSERT INTO google_card (email, phone, g_amount_100, g_quantity_100, g_price_100, g_amount_50, g_quantity_50, g_price_50, g_amount_25, g_quantity_25, g_price_25, status,  bank, account_name, account_number, currency, image, t_ref)
...
'$amount_25', '$quantity_25', '$price_25', '$status', '$bank', '$account_name', '$account_number', '$currency', '".$image."', '$ref')";
        ...
        header('Refresh:5; url=google-trades');
        $_SESSION['success']  = "Google Trade Successful!! Trade Reference ID: $ref ";

    }

    if ($db->query === TRUE) {
        echo "<script>alert('Google Trade Successful. We Will Contact You. .$ref')</script>";
    ...
    <main>
        <div class="container-fluid">
            ...
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active">Sell Google Gift Card</li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div id="Dollar" class="tabcontent">
                            <br>
                            <h6>Dollar Trade</h6>
                            <form method="POST" action="google-card" enctype='multipart/form-data' >
                                ...
                                <div class="row">
                                                ...
                                                <table border="0">
                                                    <tr>
                                                        ...
                                                        <td><input type="hidden" value="    <?php
                                                            ...
                                                            ?> " id="d_amount_100" name="g_amount_100" oninput="google100()"></td>

                                                        <td><label>Quantity</label> <i class="text-danger">*</i>
                                                            <input type="number" value="" id="d_quantity_100"  name="g_quantity_100" class="form-control" oninput="google100()"  title="Enter Quantity to get price"></td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <input type="text" id="d_price_100" class="form-control"  name="g_price_100" placeholder="0" readonly>
                                                ...
                                                <table border="0">
                                                    <tr>
                                                        ...
                                                        <td><input type="hidden" value="     <?php
                                                            ...
                                                            ?> " id="d_amount_50" name="g_amount_50" oninput="google50()"></td>

                                                        <td><label>Quantity</label> <i class="text-danger">*</i>
                                                            <input type="number" value="" id="d_quantity_50" name="g_quantity_50" class="form-control" oninput="google50()"  title="Enter Quantity to get price"></td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <input type="text" id="d_price_50" value="" name="g_price_50" class="form-control" placeholder="0" readonly>
                                                ...
                                                <table border="0">
                                                    <tr>
                                                        ...
                                                        <td><input type="hidden" value="     <?php
                                                            ...
                                                            ?> " id="d_amount_25" name="g_amount_25" oninput="google25()"></td>

                                                        <td><label>Quantity</label> <i class="text-danger">*</i>
                                                            <input type="number" value="" id="d_quantity_25" name="g_quantity_25" class="form-control" oninput="google25()" title="Enter Quantity to get price"></td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <input type="text" id="d_price_25" class="form-control" name="g_price_25" placeholder="0"  readonly>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <label>Upload Google Card</label><i class="text-danger">*</i>
                                        ...
                                        <!-- submit button -->
                                        <div class="form-group ">
                                            <br><br><input type="submit" name="save" class="btn btn-sm btn-color btn-primary" value="Trade Google Dollar">
                                        </div>
                            ...
                            <form method="POST" action="google-card" enctype='multipart/form-data' >
                                ...
                                <div class="row">
                                                ...
                                                <table border="0">
                                                    <tr >
                                                        ...
                                                        <td><input type="hidden" value=" <?php
                                                            ...
                                                            ?> "  name="g_amount_100" id="p_amount_100" oninput="pounds100()"></td>

                                                        <td><label>Quantity</label> <i class="text-danger">*</i>
                                                            <input type="number"  id="p_quantity_100"  oninput="pounds100()"  name="g_quantity_100" class="form-control" oninput="google100()"  title="Enter Quantity to get price"></td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <input type="text" id="p_price_100" class="form-control"  oninput="pounds100()" name="g_price_100" placeholder="0" readonly>
                                                ...
                                                <table border="0">
                                                    <tr>
                                                        ...
                                                        <td><input type="hidden" value="     <?php
                                                            ...
                                                            ?> " id="p_amount_50" name="g_amount_50" oninput="pounds50()"></td>

                                                        <td><label>Quantity</label> <i class="text-danger">*</i>
                                                            <input type="number"  id="p_quantity_50"  oninput="pounds50()"name="g_quantity_50" class="form-control" oninput="google50()"  title="Enter Quantity to get price"></td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <input type="text" id="p_price_50" oninput="pounds50()"name="g_price_50" class="form-control" placeholder="0" readonly>
                                                ...
                                                <table border="0">
                                                    <tr>
                                                        ...
                                                        <td><input type="hidden" value="     <?php
                                                            ...
                                                            ?> " id="p_amount_25" name="g_amount_25" oninput="pounds25()"></td>

                                                        <td><label>Quantity</label> <i class="text-danger">*</i>
                                                            <input type="number"  id="p_quantity_25" oninput="pounds25()" name="g_quantity_25" class="form-control" oninput="google25()" title="Enter Quantity to get price"></td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <input type="text" id="p_price_25"  oninput="pounds25()" class="form-control" name="g_price_25" placeholder="0"  readonly>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <!-- submit button -->
                                        <div class="form-group ">
                                            <br><br><input type="submit" name="save" class="btn btn-sm btn-color btn-primary" value="Trade Google Pounds">
                                        </div>
                            ...
                            <form method="POST" action="google-card" enctype='multipart/form-data' >
                                ...
                                <div class="row">
                                                ...
                                                <table border="0">
                                                    <tr >
                                                        ...
                                                        <td><input type="hidden" value=" <?php
                                                            ...
                                                            ?> "  name="g_amount_100" id="e_amount_100" oninput="euro100()"></td>

                                                        <td><label>Quantity</label> <i class="text-danger">*</i>
                                                            <input type="number"  id="e_quantity_100"  oninput="euro100()" name="g_quantity_100" class="form-control" oninput="google100()"  title="Enter Quantity to get price"></td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <input type="text" id="e_price_100" class="form-control"  oninput="euro100()" name="g_price_100" placeholder="0" readonly>
                                                ...
                                                <table border="0">
                                                    <tr>
                                                        ...
                                                        <td><input type="hidden" value="     <?php
                                                            ...
                                                            ?> " id="e_amount_50" name="g_amount_50" oninput="euro50()"></td>

                                                        <td><label>Quantity</label> <i class="text-danger">*</i>
                                                            <input type="number"  id="e_quantity_50"  oninput="euro50()"name="g_quantity_50" class="form-control" oninput="google50()"  title="Enter Quantity to get price"></td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <input type="text" id="e_price_50" oninput="euro50()"name="g_price_50" class="form-control" placeholder="0" readonly>
                                                ...
                                                <table border="0">
                                                    <tr>
                                                        ...
                                                        <td><input type="hidden" value="     <?php
                                                            ...
                                                            ?> " id="e_amount_25" name="g_amount_25" oninput="euro25()"></td>

                                                        <td><label>Quantity</label> <i class="text-danger">*</i>
                                                            <input type="number"  id="e_quantity_25" oninput="euro25()" name="g_quantity_25" class="form-control" oninput="google25()" title="Enter Quantity to get price"></td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <input type="text" id="e_price_25"  oninput="euro25()" class="form-control" name="g_price_25" placeholder="0"  readonly>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <!-- submit button -->
                                        <div class="form-group ">
                                            <br><br><input type="submit" name="save" class="btn btn-sm btn-color btn-primary" value="Trade Google Euro">
                                        </div>
