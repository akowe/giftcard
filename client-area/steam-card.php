...
if (isset($_POST["save"])) {
    ...
    if( in_array($imageFileType,$extensions_arr) ){
        ...
        // Insert record
        $query = "INSERT INTO steam_card (phone, email, amount_100, quantity_100, price_100, amount_50, quantity_50, price_50, amount_25, quantity_25, price_25, status,  bank, account_name, account_number, currency, image, t_ref)
...
'$amount_25', '$quantity_25', '$price_25', '$status', '$bank', '$account_name', '$account_number', '$currency', '".$image."', '$ref')";
        ...
        header('Refresh:3; url=steam-trades');
        $_SESSION['success']  = "Steam Trade Successful!! Trade ID $ref";

    }

    if ($db->query === TRUE) {
        echo "<script>alert('Steam Trade Successful. We Will Contact You. Trade ID $ref')</script>";
            ...
            <main>
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Sell Steam Gift Card</li>
                                    ...
                                    <form method="POST" action="" enctype='multipart/form-data' >
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <label>Upload Steam Card</label><i class="text-danger">*</i>
                                                ...
                                                <!-- submit button -->
                                                <div class="form-group ">
                                                    <br><br><input type="submit" name="save" class="btn btn-sm btn-color btn-primary" value="Trade Steam Dollar">
                                                </div>
                                    ...
                                    <form method="POST" action="" enctype='multipart/form-data' >
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <!-- submit button -->
                                                <div class="form-group ">
                                                    <br><br><input type="submit" name="save" class="btn btn-sm btn-color btn-primary" value="Trade Steam Pounds">
                                                </div>
                                    ...
                                    <form method="POST" action="" enctype='multipart/form-data' >
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <!-- submit button -->
                                                <div class="form-group ">
                                                    <br><br><input type="submit" name="save" class="btn btn-sm btn-color btn-primary" value="Trade Steam Euro">
                                                </div>
