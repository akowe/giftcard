                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            if (isset($_POST['rate_btn'])) {
                                ...
                                $d50 = e($_POST['d50']);
                                $d25 = e($_POST['d25']);
                                $query = "UPDATE `google_rates` SET dollar_100 = '$d100', dollar_50 = '$d50', dollar_25 = '$d25' ";
                                $results = mysqli_query($db, $query);
                                if ($results == 1) {
                                    echo "<script>alert('Google Dollar Rate Updated')</script>";
                                } else {
                            ...
                            <?php
                            global $db;
                            $query = "SELECT dollar_100, dollar_50, dollar_25 from google_rates";
                            $results = mysqli_query($db, $query);
                        ...
                        <div class="col-lg-4">
                            ...
                            if (isset($_POST['pounds_rate_btn'])) {
                                ...
                                $d50 = e($_POST['d50']);
                                $d25 = e($_POST['d25']);
                                $query = "UPDATE `google_pounds_rates` SET pounds_100 = '$d100', pounds_50 = '$d50', pounds_25 = '$d25' ";
                                $results = mysqli_query($db, $query);
                                if ($results == 1) {
                                    echo "<script>alert('Google Pounds Rate Updated')</script>";
                                } else {
                                    array_push($errors, "Not Updated");
                                }
                            ...
                            <?php
                            global $db;
                            $query = "SELECT pounds_100, pounds_50, pounds_25 from google_pounds_rates";
                            $results = mysqli_query($db, $query);
                            if($results->num_rows > 0) {
                                echo "<br>
                             No of records : ".$results->num_rows."<br>";
                        ...
                        <div class="col-lg-4">
                            ...
                            if (isset($_POST['euro_rate_btn'])) {
                                ...
                                $d50 = e($_POST['d50']);
                                $d25 = e($_POST['d25']);
                                $query = "UPDATE `google_euro_rates` SET euro_100 = '$d100', euro_50 = '$d50', euro_25 = '$d25' ";
                                $results = mysqli_query($db, $query);
                                if ($results == 1) {
                                    echo "<script>alert('Google Euro Rate Updated')</script>";
                                } else {
                                    array_push($errors, "Not Updated");
                                }
                            ...
                            <?php
                            global $db;
                            $query = "SELECT euro_100, euro_50, euro_25 from google_euro_rates";
                            $results = mysqli_query($db, $query);
                            if($results->num_rows > 0) {
                                echo "<br>
                             No of records : ".$results->num_rows."<br>";
