                    ...
                    <div class="table-responsive" >
                        ...
                        <table class="table table-bordered"  id="" width="100%" cellspacing="0">
                            ...
                            if (isset($_POST['cancel_btn'])) {
                                ...
                                $id=$_POST['id'];
                                $query = "UPDATE `nike_card` SET status = '$update' WHERE id ='$id'";
                            ...
                            $total_pages_sql = "SELECT COUNT(*) FROM nike_card ORDER BY date DESC ";
                            $result = mysqli_query($db,$total_pages_sql);
                            $total_rows = mysqli_fetch_array($result)[0];
                            $total_pages = ceil($total_rows / $no_of_records_per_page);
                            $second_last = $total_pages - 1; // total page minus 1

                            $sql = "SELECT * FROM nike_card ORDER BY date DESC  LIMIT $offset, $no_of_records_per_page";
