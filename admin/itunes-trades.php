                ...
                <div class="col-xl-6 col-md-6">
                    <div class="card bg-success text-white mb-4">
                        <div class="card-body">Successful Trade (
                            ...
                            $query = "SELECT COUNT(status) FROM itunes_card WHERE status = 'Completed'";
                ...
                <div class="col-xl-6 col-md-6">
                    <div class="card bg-danger text-white mb-4">
                        <div class="card-body">Pending Trade (
                            ...
                            $query = "SELECT COUNT(status) FROM itunes_card WHERE status = 'Pending'";
                            $result = $db->query($query);
                            // Print out result
                            while($row = $result->fetch_assoc()){
                                echo  $row['COUNT(status)'];
                    ...
                    <div class="table-responsive" >
                        ...
                        <table class="table table-bordered"  id="" width="100%" cellspacing="0">
                            ...
                            if (isset($_POST['cancel_btn'])) {
                                ...
                                $id=$_POST['id'];
                                $query = "UPDATE `itunes_card` SET status = '$update' WHERE id ='$id'";
                            ...
                            $total_pages_sql = "SELECT COUNT(*) FROM itunes_card ORDER BY date DESC ";
                            $result = mysqli_query($db,$total_pages_sql);
                            $total_rows = mysqli_fetch_array($result)[0];
                            $total_pages = ceil($total_rows / $no_of_records_per_page);
                            $second_last = $total_pages - 1; // total page minus 1

                            $sql = "SELECT * FROM itunes_card ORDER BY date DESC  LIMIT $offset, $no_of_records_per_page";
