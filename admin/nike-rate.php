...
if (isset($_POST['rate_btn'])) {
    ...
    $query = "UPDATE `nike_rates` SET dollar_100 = '$d100', dollar_50 = '$d50', dollar_25 = '$d25' ";
    ...
    <main>
        <div class="container-fluid">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="nike-rate">
                    ...
                    <?php
                    global $db;
                    $query = "SELECT dollar_100, dollar_50, dollar_25 from nike_rates";
                    $results = mysqli_query($db, $query);
