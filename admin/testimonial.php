            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-md-6">
                    <div class="card bg-success text-white mb-4">
                        <div class="card-body">Approved Testimonials (
                            <?php
                            global $db;

                            $query = "SELECT COUNT(status) FROM testimonial where status='Approved'";
                ...
                <div class="col-xl-6 col-md-6">
                    <div class="card bg-danger text-white mb-4">
                        <div class="card-body">Pending Testimonials (
                            <?php
                            global $db;
                            $query = "SELECT COUNT(status) FROM testimonial where status='Pending'";
                            $result = $db->query($query);
                            // Print out result
                            while($row = $result->fetch_assoc()){
                                echo  $row['COUNT(status)'];
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive" >
                        ...
                        if (isset($_POST['cancel_btn'])) {
                            ...
                            $id=$_POST['id'];
                            $query = "UPDATE `testimonial` SET status = '$update' WHERE id ='$id'";
                        ...
                        <table class="table table-bordered"  id="" width="100%" cellspacing="0">
                            ...
                            $total_pages_sql = "SELECT COUNT(*) FROM testimonial ORDER BY date DESC ";
                            $result = mysqli_query($db,$total_pages_sql);
                            $total_rows = mysqli_fetch_array($result)[0];
                            $total_pages = ceil($total_rows / $no_of_records_per_page);
                            $second_last = $total_pages - 1; // total page minus 1

                            $sql = "SELECT * FROM testimonial ORDER BY date DESC  LIMIT $offset, $no_of_records_per_page";
